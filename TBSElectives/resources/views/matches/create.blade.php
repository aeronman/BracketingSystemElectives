                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('matches.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="round_number" id="round_number" value="{{ old('round_number') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        </div>
                        <div class="mb-4">
                            <label for="match_number" class="block text-gray-700">Match Number:</label>
                            <input type="number" name="match_number" id="match_number" value="{{ old('match_number') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        </div>
                        <div class="mb-4">
                        ...
                        <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700">Add Match</button>
                    </form>
                </div>
            </div>
        </div>
